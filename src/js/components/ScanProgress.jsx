		...
		<Card className="vmfa-scan-progress">
			...
			<CardBody>
				<div className="vmfa-progress-info">
					...
					<div
						className={`vmfa-progress-bar-container${isRunning && status.processed === 0 ? ' vmfa-progress-indeterminate' : ''}`}
					>
						<div
					...
					{isRunning && status.processed === 0 && (
						<div className="vmfa-progress-hint">
							{__(
								'Connecting to AI provider and analyzing first batch… Initialization may take a couple of minutes.',
								'vmfa-ai-organizer'
							)}
						</div>
					)}
...
function ResultsList({ results }) {
	...
	return (
		<div className="vmfa-recent-results">
			<h4>
				{__('Recent Results', 'vmfa-ai-organizer')} ({results.length})
			</h4>
				...
				{sortedResults.map((result, index) => (
					...
					>
						...
						>
							...
							<span
								className="vmfa-result-filename"
								title={
									result.filename ||
						...
						{expandedItems[index] && (
							<div className="vmfa-result-details">
								<dl>
									...
									<dt>
										{__('Confidence:', 'vmfa-ai-organizer')}
									</dt>
									<dd>
										{Math.round(
									...
									<dd className="vmfa-result-reason-text">
										{result.reason ||
											__(
												'No reason provided',
												'vmfa-ai-organizer'
