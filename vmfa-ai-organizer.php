...
// Plugin constants.
define( 'VMFA_AI_ORGANIZER_VERSION', '0.1.0' );
				...
				<div class="notice notice-error">
					<p>
						...
						printf(
							...
							esc_html__( '%s requires Virtual Media Folders to be installed and activated.', 'vmfa-ai-organizer' ),
							'<strong>Virtual Media Folders AI Organizer</strong>'
						);
						?>
					</p>
				</div>
